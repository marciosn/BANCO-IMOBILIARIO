...
public class LogradouroComercializavel_Imovel extends LogradouroComercializavel implements IComportamentoLogradouro{

	public LogradouroComercializavel_Imovel(String nome, float valor, float taxa, Point posicao) {
